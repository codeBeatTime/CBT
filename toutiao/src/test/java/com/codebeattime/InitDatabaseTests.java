...
public class InitDatabaseTests {
    ...
    public void initData() {
        ...
        for (int i = 0; i < 11; ++i) {
            User user = new User();
            user.setHeadUrl(String.format("http://images.codebeattime.com/head/%dt.png", random.nextInt(1000)));
            ...
            news.setImage(String.format("http://images.codebeattime.com/head/%dm.png", random.nextInt(1000)));
            news.setLikeCount(i+1);
            news.setUserId(i+1);
            news.setTitle(String.format("TITLE{%d}", i));
            news.setLink(String.format("http://www.codebeattime.com/%d.html", i));
        ...
        List<User> lists =  userDAO.getUsersRank(0,100);
